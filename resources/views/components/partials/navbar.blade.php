            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
                    <div class="header-top-info mb-2 mb-md-0 float-right">
                        <a href="tel:+880161-7061174">Call Us : <span>+880161-7061174</span></a>
                        <a href="mailto:support.saveyouthbd@gmail.com"><i
                                class="fas fa-envelope mr-2"></i><span>support.saveyouthbd@gmail.com</span></a>
                    </div>
                </div>
            </div>
        </div>
